...
const styles = StyleSheet.create({
  ...
  header: { textAlign: 'center', marginBottom: 20, borderBottomWidth: 1, borderBottomColor: '#cccccc', paddingBottom: 10 },
...
export const ReciboSalarioPDF = ({ empleado, pago }) => {
  return (
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <Text style={styles.col}>Salario Ordinario Devengado</Text>
          ...
          {Number(pago.adelanto_salario) > 0 && (
            <View style={styles.tableRow}>
              <Text style={styles.col}>Adelanto Salarial / Préstamo</Text>
